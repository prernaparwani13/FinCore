    ...
    <div className="w-full bg-white font-sans text-slate-900">
      ...
      <section className="max-w-[1200px] mx-auto px-6 mb-32">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {topCards.map((card, i) => (
            <div key={i} className="bg-white dark:bg-slate-900 rounded-[2rem] p-8 text-center flex flex-col items-center hover:shadow-md dark:hover:shadow-slate-800/50 transition-shadow border border-slate-100 dark:border-slate-800">
      ...
      <section className="text-center mb-32">
        <h2 className="text-3xl font-bold mb-16 text-slate-900 dark:text-white">Why Choose FinCore?</h2>
      ...
      <section className="max-w-[1500px] max-h-[1400px] mx-auto px-13 py-20 mb-32 bg-white dark:bg-slate-900">
        <div className="relative bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 rounded-[2rem] p-14 overflow-hidden flex flex-col md:flex-row items-center justify-between">
