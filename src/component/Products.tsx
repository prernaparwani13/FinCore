    ...
    <section className="py-10 bg-slate-100 dark:bg-slate-950 flex flex-col items-center">
      ...
      <div className="w-full max-w-[1000px] px-1 md:px-1 lg:px-1">
        ...
        <div className="text-center mb-20">
          <h2 className="text-4xl md:text-6xl font-bold text-[#0f172a] dark:text-white mb-6">
            Our Products
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          {products.map((product) => (
            <div
              ...
              className="group p-6 md:p-8 rounded-3xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm hover:shadow-md hover:scale-105 hover:bg-slate-50 dark:hover:bg-slate-800 hover:border-blue-500 transition-all flex flex-col">
              {/* Icon Container */}
              ...
              <div className="flex-grow">
                <h3 className="text-2xl md:text-3xl font-bold text-[#0f172a] dark:text-white mb-3">
                  {product.title}
                </h3>

                <p className="text-slate-500 text-sm md:text-[15px] leading-relaxed max-w-[390px] dark:text-slate-300">
                  {product.description}
                </p>
              </div>
              ...
              <div className="mt-8">
                <a
                  href="#"
                  className="inline-flex items-center gap-2 text-blue-600 font-semibold text-sm md:text-[15px] hover:gap-3 transition-all"
                >
