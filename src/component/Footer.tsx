...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="w-full  bg-slate-100 dark:bg-slate-900/50 py-10 sm:py-15  border-t border-slate-100 dark:border-slate-900 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-8"> {/* Increased px-2 to px-4 for better mobile gutters */}
        ...
        <div className="flex flex-col items-center space-y-8">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 sm:gap-12 md:gap-16 lg:gap-20 opacity-70 dark:opacity-40 grayscale hover:grayscale-0 transition-all duration-500">
  {partners.map((partner) => (
    ...
    >
      {/* Icon */}
      <span className="text-xl text-slate-600 dark:text-slate-300 group-hover:text-blue-500 dark:group-hover:text-blue-300 transition-colors duration-300">
        {partner.icon}
      </span>
